                    ...
                    <div class="row">
                        <div class="col-sm-12 swog-form ">
                            <form action="/action_page.php">
                              <div class="row ">
                                <div class="col-sm-6 d-flex justify-content-center">  <a href=""  type="submit" class="btn btn-primary view-my-button3"><i class="fa fa-download" aria-hidden="true"></i>
                                    Download Your Subscription Form </a></div>
                                <div class="col-sm-6 d-flex justify-content-center">  <a href="{{url('swog14')}}"  type="submit" class="btn btn-primary view-my-button2">Next <i class="fa-solid fa-arrow-right"></i></a></div>
                              </div>
