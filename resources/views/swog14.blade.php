        ...
        <section class="ev-content pt-50">
            <div class="container">
                <div class="row">
                    ...
                    <img class=" position-relative" src="img/arrow33.png" alt="">
                    <p class="position-absolute invest2"><span class="one2">1</span> Select Investment</p>
                </div>
              <div class="row">
                <p class="new-lorem my-5">Lorem ipsum dolor sit amet consectetur. Dictumst suscipit tortor amet maecenas hac ut morbi. Mi in sagittis pulvinar rhoncus purus metus volutpat vivamus a.</p>
              </div>
                <div class="row text-center">
                    ...
                    <div class="col-md-5 col-sm-12 text-center">
                        <div class="box-content left-box">
                            ...
                            <a href="identity-doc.html">Upload</a>
                        </div>
                    </div>
                    <div class="col-md-5 col-sm-12">
                        <div class="box-content right-box ">
                            ...
                            <a href="verification.html">Upload</a>
                        </div>
                    </div>
                ...
                <div class="row d-flex justify-content-center">
                    <a href="{{url('swog15')}}" class="btn main-next">Next</a>
                </div>
