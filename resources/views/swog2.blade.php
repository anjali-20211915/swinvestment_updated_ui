        ...
        <section class="ind-main-bnr">
            <div class="container-fluid bg-light h-100">
                <div class="container bg-light  ">
                    ...
                    <div class="row">
                        <div class="col-sm-12 swog-form form-describe">
                            <form action="{{url('swog3')}}">
                                ...
                                <div class="form-check">
                                    ...
                                    <div class="row d-flex flex-column" >
                                        ...
                                        <p class="check-lab">Invest with a beneficiary with equal ownership</p>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <div class="row d-flex align-items-end">
                                    ...
                                    <div class="row d-flex flex-column" >
                                        ...
                                        <p class="check-lab">Invest as a single-member LLC or partnership</p>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <div class="row d-flex align-items-end">
                                    ...
                                    <div class="row d-flex flex-column" >
                                        ...
                                        <p class="check-lab">Invest as an individual, business or investment trust</p>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <div class="row d-flex align-items-end">
                                    ...
                                    <div class="row d-flex flex-column" >
                                        ...
                                        <p class="check-lab">Invest as a C Corporation or S Corporation</p>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <div class="row d-flex align-items-end">
                                    ...
                                    <div class="row d-flex flex-column" >
                                        ...
                                        <p class="check-lab">Invest as a Partnership</p>
                                    </div>
                                </div>
